...
function wpc_block_assets() {
	...
	wp_register_style(
		'wpc-block-style-css',
		plugins_url( 'wpc-block-editor-style-css', dirname( __FILE__ ) ),
...
//include food tab block
if( file_exists( \Wpcafe::plugin_dir() . 'core/modules/guten-block/inc/blocks/pickup-delivery.php' )){
	include_once \Wpcafe::plugin_dir() . 'core/modules/guten-block/inc/blocks/pickup-delivery.php';
}
